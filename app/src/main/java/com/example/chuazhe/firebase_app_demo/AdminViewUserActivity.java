...
public class AdminViewUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                builder
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                db1.collection("user").document(getId)
                                        .delete()
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdminViewUserActivity.this, AdminEditUserActivity.class);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        array_list.add("Matric No: " + (data.get("matricNo").toString()));
                        array_list.add("Name: " + (data.get("userName").toString()));
                        array_list.add("Email: " + data.get("userEmail").toString());
                        array_list.add("MyCSD: " + (data.get("MyCSD").toString()));
